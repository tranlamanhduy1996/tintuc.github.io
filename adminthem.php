<?php
    ...
    if (isset($_POST['dangbai'])) {
        ...
        $idloaitin=$_POST['idloaitin'];
            $baiviet = $c_baiviet->thembaiviet($tieude,$tieudekhongdau,$tomtat,$noidung,$hinh,$idloaitin);
    } 
 ?>
<!DOCTYPE html>
<html lang="en">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li class="active">
                        <a href="index.html"><i class="fa fa-fw fa-dashboard"></i> Thêm Bài Viết</a>
                    </li>
                    <li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <h1 class="page-header">
                            Bài Viết <small>Thêm Bài Viết</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-dashboard"></i> Thêm Bài Viết Mới
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <form method="POST" action="#">
                            ...
                            <div class="form-group text-center">
                                 <button type="submit" class="btn btn-primary" name="dangbai">Đăng Bài</button>
                            </div>
                        </form>
                    </div>
